...
export default function Hero() {
  ...
  return (
    <header ref={heroRef} className="hero" id="home">
      ...
      <div className="hero-bottom"><a href="#about">SCROLL TO EXPLORE <span aria-hidden="true">↓</span></a><a className="hero-cv-link" href={siteUrl("cv")}>CV / 2026 <span aria-hidden="true">↗</span></a></div>
    </header>
  );
}
