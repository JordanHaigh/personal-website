...
it("provides a readable CV with experience, contact details and a direct PDF download", () => {
  ...
  expect(screen.getByRole("link", { name: "Back to portfolio", exact: true }).getAttribute("href")).toBe(import.meta.env.BASE_URL);
  ...
  expect(download.getAttribute("href")).toBe(`${import.meta.env.BASE_URL}Jordan-Haigh-CV.pdf`);
